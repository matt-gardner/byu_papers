...
far better to use speculative methods than standard parallelizations.  We can
also assume that at some point above 800 processors, Many Iterations will be
become successful and will be the preferred method.  Once there are enough
particles in the swarm to guarantee success when optimizing a function, the
best use of additional processors is to speculate as far ahead as possible,
speeding up the progress of the algorithm.
