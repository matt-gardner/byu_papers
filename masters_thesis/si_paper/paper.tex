...
Bare Bones PSO equations.  We see a decrease in time to completion between
Standard and speculative parallelizations of 40\%.  While this is not quite as
large a speed up as the 60\% seen with constricted PSO, it is still a
...
other than the standard constricted PSO.  Our intent is not to give an
exhaustive listing of PSO variants and compare parallelization strategies with
each one; instead we offer evidence supporting our claim that speculative
evaluation should see similar increases in performance across most or all PSO
variants.
