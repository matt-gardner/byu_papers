...
\begin{table}
  ...
  algorithm is bolded, meaning that it has at least 90\% complete and its mean
  time to completion is significantly lower than all non-bolded algorithms,
  with a p-value of less than $10^{-5}$.}
  \label{tab:sphere-20}
  \centering
