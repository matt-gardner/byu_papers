\documentclass[ms,electronic,twosidetoc,letterpaper,chaptercenter,parttop,equalmargins]{byumsphd}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Thesis formating stuff
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newcommand{\Title}{A Speculative Approach to Parallelization\\
in Particle Swarm Optimization}
\newcommand{\Author}{Matthew Gardner}
\newcommand{\GraduationMonth}{August}
\newcommand{\GraduationYear}{2011}
...
processors.  In this thesis we present a speculative approach to the
...
\section{Recovering from Pruning Too Much}
\label{sec:wrong}
