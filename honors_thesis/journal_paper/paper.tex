...
are shown in \fig{griewank-manyiters}. 
...
slower than PSO Complete and got stuck around 15\% of the time.  Using Pick
Best, Pick Best Pruned, and Many Iterations all outperformed PSO Complete,
though Many Iterations only almost reached a 100\% success rate.
