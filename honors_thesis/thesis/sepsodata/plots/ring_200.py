...
SEPSO_FILE = '../sepso_reproduce/function/ring50particles'
PICKBEST_FILE = '../sepso_pickbest/function/ring50particles'
STANDARD_FILE = '../standardpso/function/ring200particles'
...
for f, function in enumerate(FUNCTIONS):
    ...
    plot.title = 'Ring topology, 50 and 200 particles, function: %s' % function
