...
SEPSO_FILE = '../sepso_reproduce/griewank/ring400particles'
PICKBEST_FILE = '../sepso_pickbest/griewank/ring400particles'
STANDARD_RAND = '../standardpso/griewank/ring1600particles'
