...
FUNCTION_RANGE = [(10 ** -25, 10 ** 5), (0, 300), (10, float(10 ** 10)),
        (10 ** -3, 500), (10 ** -10, 100)]

FUNCTION_LOGSCALE = [10, 0, 10, 10, 10]

SEPSO_FILE = '../sepso_reproduce/function/rand50particles'
PICKBEST_FILE = '../sepso_pickbest/function/rand50particles'
STANDARD_RAND = '../standardpso/function/rand200particles'
STANDARD_COMPLETE = '../standardpso/function/complete200particles'
...
for f, function in enumerate(FUNCTIONS):
    ...
    plot.title = 'Complete topology, 50 and 200 particles, function: %s' \
            % function
