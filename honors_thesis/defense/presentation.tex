...
\begin{frame}
  ...
  \includegraphics[width=\textwidth]{cosine.eps}
\end{frame}
...
\begin{frame}
  \begin{center}
	...
	\includegraphics[width=.6\textwidth]{sphere1.eps}
  \end{center}
\end{frame}
\begin{frame}
  \begin{center}
	...
	\includegraphics[width=.6\textwidth]{griewank1.eps}
  \end{center}
\end{frame}
\begin{frame}
  \begin{center}
	...
	\[f(\Vec{x}) = \frac{1}{4000} \sum_{i=1}^D x_i^2 - \Pi_{i=1}^D 
	\cos\left(\frac{x_i}{\sqrt{i}}\right) + 1\]
	\includegraphics[width=.6\textwidth]{griewank2.eps}
  \end{center}
\end{frame}
\begin{frame}
  \begin{center}
	...
	10\right)\]
	\includegraphics[width=.6\textwidth]{rastrigin.eps}
  \end{center}
\end{frame}
