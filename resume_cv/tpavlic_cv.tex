...
795 Walnut Avenue & \textit{E-mail:} mjg82@byu.edu\\
Provo, UT 84604 USA    & \\
\end{tabular}
...
\section{Publications} \begin{bibsection}
    \item Pavlic, T.P., and K.M.~Passino. Cooperative task
        processing. \emph{IEEE Transactions of Automatic Control}. 2009.
        Submitted.

    \item Pavlic, T.P., and K.M.~Passino. When rate maximization is
        impulsive. \emph{Behavioral Ecology and Sociobiology}. 2009.
        Accepted pending revisions.

    \item Pavlic, T.P., and K.M.~Passino. The sunk-cost effect and
        other optimal rate-maximizing behaviors. \emph{Acta
        Biotheoretica}. 2009. Submitted.

    \item Pavlic, T.P., and K.M.~Passino. Foraging theory for mobile
        agent speed choice. \emph{Engineering Applications of Artificial
        Intelligence}, 22(3):482--489, April 2009.
