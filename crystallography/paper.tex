...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Results
\section{Results (Maybe Issues with Optimization?)}
\label{sec:results}
TODO.
...
parameters took on, without changing the function value more than (check number)
.5, or this \%.  Upon noticing this empirical correlation, the function was
more closely examined, and a theoretical correlation was also discovered.  
...
Work has been done on the use of particle swarm optimization in parallel with 
large numbers of particles \cite{mcnabb-gecco09}.
